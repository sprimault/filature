...
// Package greffons embarque le contenu livré dans le binaire.
//
...
// chemin qu'un greffon posé sur le disque. C'est ce qui garantit que ce chemin
...
//
// Chaque entrée de la racine est un greffon, comme dans le dossier que désigne
// --greffons : « base » porte les règles, les formes et le français, « anglais »
// la traduction.
func Livres() fs.FS {
	return embarques
}
