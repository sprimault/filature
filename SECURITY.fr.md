...
par le trafic réseau, un fichier de sauvegarde, un greffon ou un bot — est un
vrai défaut, pas une curiosité. À signaler.

**Le bac à sable des greffons.** Un module WebAssembly ne doit atteindre ni le
disque, ni le réseau, ni l'horloge, ni l'entropie système. Une évasion est une
vulnérabilité.

## Hors périmètre

- Ce qu'un joueur fait sur sa propre machine. Charger un greffon non vérifié en
