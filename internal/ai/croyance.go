...
//
//   - propagation : le fugitif a pu se déplacer d'une case dans huit directions ;
...
func (c *Croyance) Barycentre() core.Position {
	// à implémenter : étape 9
