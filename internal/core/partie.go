...
// Side désign un sideName. Le troisième cas n'existe pas : la partie se joue à
...
// Phase découpe le tour. La mise en place est une phaseName comme une autre pour
...
// Fugitive porte l'état du sideName caché. SealedZone est l'information la plus
