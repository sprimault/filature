...
func (p *Game) placeForPhase(c Move) []func() {
	...
	// phaseName : la mise en place n'a rien à rendre.
...
// targetOf traduit un sideName en cible d'effet.
...
// sideName ne déclenchera plus rien ce tour-ci. La règle pose les deux limites.
...
// endPhase rend la main au sideName suivant, et résout le tour quand les deux ont
// joué.
//
