...
// NouvelAlea dérive un flux nommé de la graine de la partie.
//
...
func NouvelAlea(graine int64, flux string) *Alea {
	...
	return &Alea{etat: h ^ uint64(graine)} // #nosec G115
}

// Entier renvoie une valeur dans [0, n[.
//
// Un n nul ou négatif renvoie zéro plutôt que de paniquer : le noyau ne
// s'arrête pas sur une erreur d'appel, et un greffon ne doit pas pouvoir faire
...
// Melanger permute une tranche sur place, par Fisher-Yates.
//
