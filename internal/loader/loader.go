...
//
// Un registre se remplit ici, et dans LoadOne qui fait le même travail pour un
// dossier isolé. Le noyau n'en fabrique pas : il n'a aucune dépendance disque,
// et lire un manifeste lui en donnerait une pour un travail qui n'est pas le
// sien.
//
